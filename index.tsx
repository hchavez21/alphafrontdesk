...
type Filter = Status | 'All' | 'Handover' | 'Follow-Up';
type SortOrder = 'newest' | 'oldest';
type Priority = 'Low' | 'Medium' | 'High';
type AppView = 'dashboard' | 'log' | 'guests' | 'reports';
  ...
  const renderView = () => {
    switch (view) {
        case 'dashboard':
            ...
            />;
        case 'guests':
            return <GuestManagement allLogs={logs} onViewGuestHistory={handleViewGuestHistory} currentUser={currentUser} onLogout={handleLogout} onAddNewGuest={() => setIsAddGuestModalOpen(true)} onEditGuest={handleOpenEditGuestModal} />;
        case 'reports':
...
const Sidebar: React.FC<SidebarProps> = ({ onSetView, activeView }) => {
    return (
