...
export const Dashboard: React.FC<DashboardProps> = ({ allLogs, onSetEditingId, onUpdateLogStatus, onViewGuestHistory, currentUser, onLogout, onAddNew }) => {
    ...
    return (
        <main className="main-content">
             <SimpleHeader title="Dashboard" currentUser={currentUser} onLogout={onLogout} />
